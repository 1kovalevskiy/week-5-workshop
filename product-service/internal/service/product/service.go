...
import (
	...
	category_service "github.com/ozon-edu-go-2021/week-5-workshop/category-service/pkg/category-service"
)

var ErrWrongCategory = errors.New("category does not exist")

//go:generate mockgen -package=product_service -destination=service_mocks_test.go -self_package=github.com/ozon-edu-go-2021/week-5-workshop/product-service/internal/service/product . IRepository,ICategoryClient
